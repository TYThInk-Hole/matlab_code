                    ...
                    if neighbor-main==1
                        if ii > pre && mod(ii,interval)==0
                            if Lattice(C(i,1),C(i,2))==2
                                stack_inter(i,2)=Trace(C(i,1),C(i,2));
                            elseif Lattice(C(i,1),C(i,2))==3
                                stack_inter(i,3)=Trace(C(i,1),C(i,2));
                            end
                        end
                    ...
                    elseif neighbor-main==-1
                        if ii > pre && mod(ii,interval)==0
                            if Lattice(R(i,1),R(i,2))==2
                                stack_inter(i,2)=Trace(R(i,1),R(i,2));
                            elseif Lattice(R(i,1),R(i,2))==3
                                stack_inter(i,3)=Trace(R(i,1),R(i,2));
                            end
                        end
                    ...
                    elseif neighbor-main==-2
                        if ii > pre && mod(ii,interval)==0
                            if Lattice(C(i,1),C(i,2))==1
                                stack_inter(i,1)=Trace(C(i,1),C(i,2));
                            end
                        end
                        Lattice(C(i,1),C(i,2))=0;
                        Trace(C(i,1),C(i,2))=0;
                    ...
                    elseif neighbor-main==2
                        if ii > pre && mod(ii,interval)==0
                            if Lattice(R(i,1),R(i,2))==1
                                stack_inter(i,1)=Trace(R(i,1),R(i,2));
                            end
                        end
                        Lattice(R(i,1),R(i,2))=0;
                        Trace(R(i,1),R(i,2))=0;
