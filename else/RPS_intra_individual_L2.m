function RPS_intra_individual_L2(Lsize,pre,ite,reproduction_rate,selection_rate,mobility,intra1,intra2,intra3)
...
for ii=1:pre+ite
    ...
    if ii == 1
        kkk=ii;
        writematrix(Trace_A,sprintf('F:/Data/RPS/data_L/intra_dt_L_80/1/%d_1_stack_intra%d.csv',kkk,intra1),'delimiter',',');
        writematrix(Trace_B,sprintf('F:/Data/RPS/data_L/intra_dt_L_80/2/%d_2_stack_intra%d.csv',kkk,intra1),'delimiter',',');
        writematrix(Trace_C,sprintf('F:/Data/RPS/data_L/intra_dt_L_80/3/%d_3_stack_intra%d.csv',kkk,intra1),'delimiter',',');
        writematrix(Lattice==1,sprintf('F:/Data/RPS/data_L/intra_dt_L_80/1_1/%d_1_stack_intra%d.csv',kkk,intra1),'delimiter',',');
        writematrix(Lattice==2,sprintf('F:/Data/RPS/data_L/intra_dt_L_80/2_1/%d_2_stack_intra%d.csv',kkk,intra1),'delimiter',',');
        writematrix(Lattice==3,sprintf('F:/Data/RPS/data_L/intra_dt_L_80/3_1/%d_3_stack_intra%d.csv',kkk,intra1),'delimiter',',');
