function RPS_inter_individual_L_Mu(Lsize,pre,ite,re1,re2,re3,selection_rate,mobility)
...
for ii=1:pre+ite
    ...
    if ii ==1
        kkk=ii;
        writematrix(Trace_A,sprintf('F:/Data/RPS/data_L/inter_dt_mu_20/1/%d_1_stack_inter%d.csv',kkk,mobility),'delimiter',',');
        writematrix(Trace_B,sprintf('F:/Data/RPS/data_L/inter_dt_mu_20/2/%d_2_stack_inter%d.csv',kkk,mobility),'delimiter',',');
        writematrix(Trace_C,sprintf('F:/Data/RPS/data_L/inter_dt_mu_20/3/%d_3_stack_inter%d.csv',kkk,mobility),'delimiter',',');
        writematrix(Lattice==1,sprintf('F:/Data/RPS/data_L/inter_dt_mu_20/1_1/%d_1_stack_inter%d.csv',kkk,mobility),'delimiter',',');
        writematrix(Lattice==2,sprintf('F:/Data/RPS/data_L/inter_dt_mu_20/2_1/%d_2_stack_inter%d.csv',kkk,mobility),'delimiter',',');
        writematrix(Lattice==3,sprintf('F:/Data/RPS/data_L/inter_dt_mu_20/3_1/%d_3_stack_inter%d.csv',kkk,mobility),'delimiter',',');
    elseif mod(ii,100)==0
        kkk=ii;
        writematrix(Trace_A,sprintf('F:/Data/RPS/data_L/inter_dt_mu_20/1/%d_1_stack_inter%d.csv',kkk,mobility),'delimiter',',');
        writematrix(Trace_B,sprintf('F:/Data/RPS/data_L/inter_dt_mu_20/2/%d_2_stack_inter%d.csv',kkk,mobility),'delimiter',',');
